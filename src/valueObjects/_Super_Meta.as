 ...
 * of this value object you may modify the generated sub-class of this class - Meta.as.
 */
...
[ExcludeClass]
public class _Super_Meta extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _MetaEntityMetadata;
    ...
    private var _internal_total_count : int;
    ...
    public function _Super_Meta()
    {
        _model = new _MetaEntityMetadata(this);
    ...
    [Bindable(event="propertyChange")]
    public function get total_count() : int
    {
    ...
    public function set total_count(value:int) : void
    {
        var oldValue:int = _internal_total_count;
        if (oldValue !== value)
        {
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _MetaEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _MetaEntityMetadata) : void
    {
        var oldValue : _MetaEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
